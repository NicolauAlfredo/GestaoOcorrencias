<%-- 
    ...
    Created on : 17/01/2019, 08:23:17
    Author     : user
--%>
            ...
            <div id="page-wrapper">                
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header text-primary" title="Ver registos"><a href="municipio_listar.jsp">Município</a></h1>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <!-- Área do corpo-->
                            <div class="col-lg-12">
                                <form role="form" accept-charset="ISO-8859-1, UTF-8" action="<%=request.getContextPath()%>/municipioServlet?comando=guardar" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" >
                                            ...
                                            <button type="submit" class="form-control btn btn-primary" onclick="municipioValidador()">Salvar</button>
                                        </div>
                                    </div>
