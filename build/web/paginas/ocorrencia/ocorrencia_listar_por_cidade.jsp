                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="ocorrencia_listar_por_testemunha.jsp">Nome Testemunha</a></li>
                        ...
                        <div class="panel-body">
                            ...
                            <form action="ocorrencia_listar_por_cidade.jsp" method="post">
                                <!-- Div com o campo de pesquisa -->
                                <div class="form-group input-group">
                                    <input type="search" name="cidade_ocorrencia" class="form-control" required placeholder="Cidade da ocorrência">
                            ...
                            <%
                                ...
                                List<Ocorrencia> ocorrencias = ocorrenciaDAO.findByCidade(cidade);
