                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="provincia_listar_por_nome.jsp" method="post">
                                <!-- Div com o campo de pesquisa -->
                                <div class="form-group input-group">
                                    <input type="search" name="nome_provincia" class="form-control" required placeholder="Nome ">
                            ...
                            <%
                                ...
                                List<Provincia> provincias = provinciaDAO.findByNome(nome);
                            %>
