            ...
            <div id="page-wrapper">                
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header text-primary" title="Ver registos"><a href=login_listar.jsp">Administrador</a></h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <!-- Área do corpo-->
                            <div class="col-lg-12">
                                <form role="form" accept-charset="ISO-8859-1, UTF-8" name="form_administrador" action="<%=request.getContextPath()%>/administradorServlet?comando=editar" method="POST">
