<%-- 
    Document   : testemunha_listar_por_nome
    Created on : 14/03/2019, 21:12:55
    Author     : user
--%>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="testemunha_listar_por_nome.jsp" method="post">
                                <!-- Div com o campo de pesquisa -->
                                <div class="form-group input-group">
                                    <input type="search" name="nome_testemunha" class="form-control" required placeholder="Nome">
