<%-- 
    Document   : testemunha_editar
    Created on : 24/02/2019, 21:30:29
    Author     : user
--%>
...
<html>
    ...
    <body>
        <%
            Testemunha testemunha = (Testemunha) request.getAttribute("testemunha");
                    ...
                    <div class="panel panel-default">                       
                        <div class="panel-heading">
                            <p class="text-primary"> 
                                Editar dados da Testemunha: <strong> <%=testemunha.getNomeTestemunha()%> </strong>
                            </p>   
                                ...
                                <form name="form_testemunha" accept-charset="ISO-8859-1, UTF-8" role="form" action="<%=request.getContextPath()%>/testemunhaServlet?comando=editar" method="POST">
                                    <div class="form-group">
                                        <div class="col-xs-6" > 
                                            ...
                                            <input type="text" class="form-control" name="id_testemunha" id="id_testemunha" value="<%=testemunha.getIdTestemunha()%>" readonly="readonly"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">                                                  
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="nome_testemunha" name="nome_testemunha" value="<%=testemunha.getNomeTestemunha()%>" required/>
                                        </div>   
                                    </div>    
                                    ...
                                    <div class="form-group">                                                  
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="pai_testemunha" name="pai_testemunha" value="<%=testemunha.getPaiTestemunha()%>" required/>
                                        </div>   
                                    </div>    
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" > 
                                            ...
                                            <input type="text" class="form-control" id="data_nascimento_testemunha" name="data_nascimento_testemunha" placeholder="dd/MM/yyyy" value="<%=DateUtil.formataData(testemunha.getDataNascimentoTestemunha())%>" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">                                                  
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="proximidade_testemunha" name="proximidade_testemunha" value="<%=testemunha.getProximidadeTestemunha()%>" required/>
                                        </div>   
                                    </div> 
                                    ...
                                    <div class="form-group">                                                  
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="estado_civil_testemunha" name="estado_civil_testemunha" value="<%=testemunha.getEstadoCivilTestemunha()%>" required/>
                                        </div>   
                                    </div> 
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" > 
                                            ...
                                            <input type="text" class="form-control" id="data_emissao_bi_testemunha" name="data_emissao_bi_testemunha" placeholder="dd/MM/yyyy" value="<%=DateUtil.formataData(testemunha.getDataEmissaoBiTestemunha())%>" required/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-xs-6" > 
                                    ...
                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="telefone_testemunha" name="telefone_testemunha" value="<%=testemunha.getTelefoneTestemunha()%>" pattern="^[9-9]{1}[1-9]{2}[0-9]{3}[0-9]{3}$"/>
                                        </div>
                                    </div>
