...
<html>
    <head>
        ...
        <script src="autuante_validador.js" type="text/javascript"></script>
    </head>
    <body>
        <%
            ...
            <div id="page-wrapper">                
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header text-primary" title="Ver registos"><a href="autuante_listar.jsp">Autuante</a></h1>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">                       
                        ...
                        <div class="panel-body">
                            <!-- Área do corpo-->
                            <div class="col-lg-12">
                                <form role="form" accept-charset="ISO-8859-1, UTF-8" action="<%=request.getContextPath()%>/autuanteServlet?comando=guardar" method="POST">
                                    <div class="form-group">                                                  
                                        <div class="col-xs-6">
                                            <label class="text-primary" for="nome_autuante"> &lowast; Nome Completo: </label>
                                            <input type="text" class="form-control" id="nome_autuante" name="nome_autuante" required/>
                                        </div>   
                                    </div>
                                    ...
                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="pai_autuante" name="pai_autuante"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="mae_autuante" name="mae_autuante"/>
                                        </div>
                                    </div>                                 
                                    ...
                                    <div class="form-group"> 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="bi_autuante" name="bi_autuante" required pattern="^[0-9]{9}[A-Z]{2}[0-9]{3}$"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="residencia_autuante" name="residencia_autuante"/>
                                        </div>
                                    </div>  
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" > 
                                            ...
                                            <input type="text" class="form-control" id="data_nascimento_autuante" name="data_nascimento_autuante" placeholder="dd/MM/yyyy" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="altura_autuante" name="altura_autuante" required/>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" >
                                            ...
                                            <input type="text" class="form-control" id="data_emissao_bi_autuante" name="data_emissao_bi_autuante" placeholder="dd/MM/yyyy" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" >
                                            ...
                                            <input type="text" class="form-control" id="data_validade_bi_autuante" name="data_validade_bi_autuante" placeholder="dd/MM/yyyy" required/>
                                        </div>
                                    </div>

                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            <label class="text-primary" for="nip_autuante"> &lowast; NIP de Autuante: </label>
                                            <input type="text" class="form-control" id="nip_autuante" name="nip_autuante" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="telefone_autuante" name="telefone_autuante" pattern="^[9-9]{1}[1-9]{2}[0-9]{3}[0-9]{3}$"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" >
                                            ...
                                            <button type="submit" class="form-control btn btn-primary" onclick="autuanteValidador()">Salvar</button>
                                        </div>
                                    </div>
