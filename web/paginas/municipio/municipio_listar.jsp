<%-- 
    ...
    Created on : 17/01/2019, 10:02:34
    Author     : user
--%>
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header text-primary" title="Registar município"><a href="municipio_registo.jsp">Município</a></h1>
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<%=request.getContextPath()%>/municipios"> <span class="glyphicon glyphicon-print"> Imprimir </span> </a></li>
                                    <li><a href="municipio_listar_por_nome.jsp"> <span class="glyphicon glyphicon-search"> Pesquisar </span> </a></li>
                                </ul>
                            </div>
