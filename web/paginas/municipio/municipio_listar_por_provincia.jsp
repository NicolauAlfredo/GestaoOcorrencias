                        ...
                        <div class="panel-heading">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="paginas/municipio/municipio_listar_por_nome.jsp">Nome Município</a></li>
                                </ul>
                            </div>
                        ...
                        <div class="panel-body">
                            <form action="municipio_listar_por_nome.jsp" method="post">
                                ...
                                <div class="form-group input-group">
                                    <input type="search" name="nome_provincia" class="form-control" required placeholder="Província">
                            ...
                            <%                                MunicipioDAO municipioDAO = new MunicipioDAO();
                                Integer provincia = Integer.parseInt(request.getParameter("nome_provincia"));
                                List<Municipio> municipios = municipioDAO.findByProvincia(provincia);
                            %>
