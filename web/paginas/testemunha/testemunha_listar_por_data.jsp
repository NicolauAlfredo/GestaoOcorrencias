<%-- 
    Document   : testemunha_listar_por_data
    Created on : 14/03/2019, 21:13:10
    Author     : user
--%>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="paginas/testemunha/testemunha_listar_por_bi.jsp">Nº do B.I</a></li>
                                </ul>
                            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <form action="testemunha_listar_por_data.jsp" method="post">
                                <!-- Div com o campo de pesquisa -->
                                <div class="form-group input-group">
                                    <input type="search" name="data_testemunha" class="form-control" required placeholder="dd/MM/yyyy">
                            ...
                            <%                                TestemunhaDAO testemunhaDAO = new TestemunhaDAO();
                                java.sql.Date data = DateUtil.strToDate(request.getParameter("data_testemunha"));
                                List<Testemunha> testemunhas = testemunhaDAO.findByData(data);
                            %>
