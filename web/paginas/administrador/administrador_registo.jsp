<%-- 
    Document   : login_registo
    Created on : 22/06/2020, 15:10:48
    Author     : user
--%>
...
<html>
    <head>
        ...
        <script src="login_validador.js" type="text/javascript"></script>
    </head>
    <body>
        <%
            ...
            <div id="page-wrapper">                
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header text-primary" title="Ver registos"><a href="administrador_listar.jsp">Administrador</a></h1>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <!-- Área do corpo-->
                            <div class="col-lg-12">
                                <form role="form" accept-charset="ISO-8859-1, UTF-8" name="form_administrador" action="<%=request.getContextPath()%>/administradorServlet?comando=guardar" method="POST">
                                    <div class="form-group">
                                        <div class="col-xs-6" > 
                                            <label class="text-primary" for="nome_administrador"> &lowast; Nome: </label>
                                            <input type="text" class="form-control" id="nome_administrador" name="nome_administrador" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" > 
                                            ...
                                            <input type="text" class="form-control" id="data_nascimento_administrador" name="data_nascimento_administrador" placeholder="dd/MM/yyyy" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" > 
                                            ...
                                            <input type="text" class="form-control" id="nip_administrador" name="nip_administrador" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" > 
                                            ...
                                            <input type="email" class="form-control" id="email_administrador" name="email_administrador"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" > 
                                            ...
                                            <input type="text" class="form-control" id="palavra_passe_administrador" name="palavra_passe_administrador" required/>
                                        </div>
                                    </div>                                    
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" >
                                            ...
                                            <button type="submit" class="form-control btn btn-primary" onclick="administradorValidador()">Salvar</button>
                                        </div>
                                    </div>
