<%-- 
    Document   : autuante_listar_por_numero
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="paginas/autuante/autuante_listar_por_nome.jsp">Nome autuante</a></li>
                        ...
                        <div class="panel-body">
                            ...
                            <form action="autuante_listar_por_numero.jsp" method="post">
                                <!-- Div com o campo de pesquisa -->
                                <div class="form-group input-group">
                                    <input type="search" name="nip_autuante" class="form-control" required placeholder="NIP">
                            ...
                            <%                                AutuanteDAO autuanteDAO = new AutuanteDAO();
                                int nipAutuante = 0;
                                List<Autuante> autuantes = autuanteDAO.findByNip(nipAutuante);
                                if (request.getParameter("nip_autuante") == null) {
                                    autuanteDAO.findByNip(nipAutuante);
                                } else {
                                    try {
                                        nipAutuante = Integer.parseInt(request.getParameter("nip_autuante"));
                                        autuantes = autuanteDAO.findByNip(nipAutuante);
                                    } catch (NumberFormatException ex) {
                                        System.out.println("Não foi passado nenhum autuante com NIP:" + ex.getMessage());
                                    }
