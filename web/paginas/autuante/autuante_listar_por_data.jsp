                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="autuante_listar_por_data.jsp" method="post">
                                <!-- Div com o campo de pesquisa -->
                                <div class="form-group input-group">
                                    <input type="search" name="data_autuante" class="form-control" required placeholder="dd/MM/yyyy">
                            ...
                            <%                                AutuanteDAO autuanteDAO = new AutuanteDAO();
                                java.sql.Date data = DateUtil.strToDate(request.getParameter("data_autuante"));
                                List<Autuante> autuantes = autuanteDAO.findByData(data);
