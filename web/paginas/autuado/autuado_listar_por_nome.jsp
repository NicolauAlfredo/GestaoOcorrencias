                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="autuado_listar_por_numero.jsp">Número autuante</a></li>
                                </ul>
                            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <form action="autuado_listar_por_nome.jsp" method="post">
                                <!-- Div com o campo de pesquisa -->
                                <div class="form-group input-group">
                                    <input type="search" name="nome_autuado" class="form-control" required placeholder="Nome">
                            ...
                            <%
                                ...
                                List<Autuado> autuados = autuadoDAO.findByNome(nome);
