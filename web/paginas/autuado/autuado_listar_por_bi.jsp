                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="autuado_listar_por_bi.jsp" method="post">
                                <!-- Div com o campo de pesquisa -->
                                <div class="form-group input-group">
                                    <input type="search" name="bi_autuado" class="form-control" required pattern="^[0-9]{9}[A-Z]{2}[0-9]{3}$" placeholder="Nº. Bilhete de Identidade">
                            ...
                            <%
                                ...
                                String numeroBI = request.getParameter("bi_autuado");
                                List<Autuado> autuados = autuadoDAO.findByBi(numeroBI);
