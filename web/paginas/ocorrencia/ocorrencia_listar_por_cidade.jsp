<%-- 
    Document   : ocorrencia_listar_por_cidade
    Created on : 14/03/2019, 21:14:45
    Author     : user
--%>
...
<html>
    ...
    <body>
        <%
            ...
            String cidade = request.getParameter("cidade_ocorrencia");
            ...
            int quantidadePaginas = ocorrenciaDAO.quantidadePaginasPorCidade(cidade);

            if (paginaActual > quantidadePaginas) {
                paginaActual = quantidadePaginas;
            }

            List<Ocorrencia> ocorrencias = ocorrenciaDAO.consultarPaginaPorCidade(
                    cidade,
            ...
            String cidadeUrl = java.net.URLEncoder.encode(cidade, "UTF-8");
        %>
                            ...
                            <form action="paginas/ocorrencia/ocorrencia_listar_por_cidade.jsp" method="get">
                                <div class="form-group input-group">
                                    <input
                                        ...
                                        class="form-control"
                                        placeholder="Cidade da ocorrência"
                                        value="<%=cidade%>"
                                        >
                                    ...
                                    <div class="text-center">
                                        <ul class="pagination">
                                            ...
                                            <li class="<%=paginaActual <= 1 ? "disabled" : ""%>">
                                                <a href="<%=paginaActual <= 1 ? "javascript:void(0)" : "paginas/ocorrencia/ocorrencia_listar_por_cidade.jsp?cidade_ocorrencia=" + cidadeUrl + "&pagina=" + paginaAnterior%>">
                                                    &laquo;
                                                </a>
                                            </li>
                                            ...
                                            <li class="<%=paginaActual >= quantidadePaginas ? "disabled" : ""%>">
                                                <a href="<%=paginaActual >= quantidadePaginas ? "javascript:void(0)" : "paginas/ocorrencia/ocorrencia_listar_por_cidade.jsp?cidade_ocorrencia=" + cidadeUrl + "&pagina=" + proximaPagina%>">
                                                    &raquo;
                                                </a>
                                            </li>
