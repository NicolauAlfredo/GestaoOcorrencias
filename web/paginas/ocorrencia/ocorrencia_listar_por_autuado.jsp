<%-- 
    Document   : ocorrencia_listar_por_autuado
    Created on : 14/03/2019, 21:13:56
    Author     : user
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            String autuado = request.getParameter("autuado_ocorrencia");
            ...
            int quantidadePaginas = ocorrenciaDAO.quantidadePaginasPorAutuado(autuado);

            if (paginaActual > quantidadePaginas) {
                paginaActual = quantidadePaginas;
            }

            List<Ocorrencia> ocorrencias = ocorrenciaDAO.consultarPaginaPorAutuado(
                    autuado,
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="paginas/ocorrencia/ocorrencia_listar_por_autuado.jsp" method="get">
                                <div class="form-group input-group">
                                    <input
                                        type="search"
                                        id="pesquisa_ocorrencia_autuado"
                                        name="autuado_ocorrencia"
                                        class="form-control"
                                        required
                                        placeholder="Autuado"
                                        value="<%=autuado%>"
                                    ...
                                    <div class="text-center">
                                        <ul class="pagination">
                                            ...
                                            <li class="<%=paginaActual <= 1 ? "disabled" : ""%>">
                                                <a href="<%=paginaActual <= 1 ? "javascript:void(0)" : "paginas/ocorrencia/ocorrencia_listar_por_autuante.jsp?autuante_ocorrencia=" + autuadoUrl + "&pagina=" + paginaAnterior%>">
                                                    &laquo;
                                                </a>
                                            </li>
                                            ...
                                            <li class="<%=i == paginaActual ? "active" : ""%>">
                                                <a href="paginas/ocorrencia/ocorrencia_listar_por_autuante.jsp?autuante_ocorrencia=<%=autuadoUrl%>&pagina=<%=i%>">
                                                    <%=i%>
                                                </a>
                                            </li>
                                            <%
                                            ...
                                            <li class="<%=paginaActual >= quantidadePaginas ? "disabled" : ""%>">
                                                <a href="<%=paginaActual >= quantidadePaginas ? "javascript:void(0)" : "paginas/ocorrencia/ocorrencia_listar_por_autuante.jsp?autuante_ocorrencia=" + autuadoUrl + "&pagina=" + proximaPagina%>">
                                                    &raquo;
                                                </a>
                                            </li>
