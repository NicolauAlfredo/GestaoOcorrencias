<%-- 
    Document   : ocorrencia_registo
    Created on : 24/02/2019, 17:50:45
    Author     : user
--%>
...
<html>
    <head>
        ...
        <script src="ocorrencia_validador.js" type="text/javascript"></script>
    </head>
    <body>
        <%
            ...
            <div id="page-wrapper">                
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header text-primary" title="Ver registos"><a href="ocorrencia_listar.jsp">Ocorrência</a></h1>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <!-- Área do corpo-->
                            <div class="col-lg-12">
                                <form role="form" accept-charset="ISO-8859-1, UTF-8" action="<%=request.getContextPath()%>/ocorrenciaServlet?comando=guardar" method="POST">
                                    ...
                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="time" class="form-control" id="hora_ocorrencia" name="hora_ocorrencia" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="rua_ocorrencia" name="rua_ocorrencia" required/>
                                        </div>
                                    </div>   
                                    ...
                                    <div class="form-group"> 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="cidade_ocorrencia" name="cidade_ocorrencia" spellcheck="true" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" >
                                            ...
                                            <textarea class="form-control" rows="3" id="descricao_ocorrencia" name="descricao_ocorrencia" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="bairro_ocorrencia" name="bairro_ocorrencia" required/>
                                        </div>
                                    </div>  
                                    ...
                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="proximidade_ocorrencia" name="proximidade_ocorrencia" required/>
                                        </div>
                                    </div>  
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" >
                                            ...
                                            <button type="submit" class="form-control btn btn-primary" onclick="ocorrenciaValidador()">Salvar</button>                                            
                                        </div>
                                    </div>
