<%-- 
    Document   : tipo_ocorrencia_registo
    Created on : 17/03/2019, 14:15:40
    Author     : user
--%>
            ...
            <div id="page-wrapper">                
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header text-primary" title="Ver registos"><a href="tipo_ocorrencia_listar.jsp">Tipo de Ocorrência</a></h1>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <!-- Área do corpo-->
                            <div class="col-lg-12">
                                <form role="form" accept-charset="ISO-8859-1, UTF-8" action="<%=request.getContextPath()%>/tipoOcorrenciaServlet?comando=guardar" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" > 
                                            ...
                                            <input type="text" class="form-control" id="nome_tipo_ocorrencia" name="nome_tipo_ocorrencia" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6" >
                                            ...
                                            <button type="submit" class="form-control btn btn-primary" onclick="tipoValidador()">Salvar</button>
                                        </div>
                                    </div>
