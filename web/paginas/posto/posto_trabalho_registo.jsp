<%-- 
    Document   : posto_trabalho_registo
    Created on : 26/02/2019, 14:09:21
    Author     : user
--%>
...
<html>
    <head>
        ...
        <script src="posto_trabalho_validador.js" type="text/javascript"></script>
    </head>
    <body>
        <%
            ...
            <div id="page-wrapper">                
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header text-primary" title="Ver registos"><a href="posto_trabalho_listar.jsp">Posto de Trabalho</a></h1>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <!-- Área do corpo-->
                            <div class="col-lg-12">
                                <form role="form" accept-charset="ISO-8859-1, UTF-8" action="<%=request.getContextPath()%>/postoTrabalhoServlet?comando=guardar" method="POST">
                                    ...
                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="nome_posto_trabalho" name="nome_posto_trabalho" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">                                                 
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" id="numero_posto_trabalho" name="numero_posto_trabalho" required/>
                                        </div>
                                    </div> 
